...
\end{tikzpicture}
\par\end{centering}
\caption{Hierarchy of weak beahvioral preorders/equivalences. Arrows denote implication of preordering.
...
\noindent
Combined, the results establish a slope of hardness between weak bisimilarity, coupled similarity,
